...
/**
 * Clase que representa una ventana para calcular el número de períodos de inversión.
 * La interfaz gráfica permite al usuario ingresar un monto inicial, un porcentaje de interés,
 * y seleccionar el tipo de interés y el tipo de tiempo para el cálculo.
 */

public class numero_periodos extends JFrame {

   /**
     * Crea una nueva instancia de la clase numero_periodos.
     * Inicializa los componentes de la ventana.
     */
    public numero_periodos() {
        initComponents();
    }
     ...
     * es regenerado por el Editor de Formas.
     * </p>
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 140, 40));

        jLabel4.setFont(new java.awt.Font("Maiandra GD", 3, 17)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Interes (%)      :");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 140, 50));
        ...
        getContentPane().add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 100, 30));
        ...
        getContentPane().add(jCheckBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, 120, 30));
        ...
        getContentPane().add(jCheckBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 290, 120, 30));

        jLabel6.setFont(new java.awt.Font("Maiandra GD", 3, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Tipo de tiempo ");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 240, 180, 50));
        ...
        jLabel7.setText("Numero de Periodos");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 270, 50));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -40, 490, 510));

        pack();
    }// </editor-fold>//GEN-END:initComponents
/**
     * Método que maneja la acción de la casilla de verificación "Meses".
     * 
     * @param evt el evento de acción que se produce al seleccionar o deseleccionar la casilla
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(numero_periodos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new numero_periodos().setVisible(true);
            }
        });
    }
