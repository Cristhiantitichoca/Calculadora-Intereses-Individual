...
/**
 * Esta clase representa una ventana de interfaz gráfica de usuario (GUI)
 * para calcular el interés ganado en base a un monto inicial, una tasa
 * de interés y un periodo de tiempo.
 * 
 * Proporciona opciones para seleccionar el tipo de interés (simple o compuesto),
 * el tipo de tiempo (mensual, semestral o anual) y calcula el interés ganado
 * al presionar el botón "Calcular".
 */
public class interes_ganado extends javax.swing.JFrame {

    /**
     * Crea una nueva instancia de la clase interes_ganado y inicializa
     ...
     * la interfaz gráfica. 
     * WARNING: No modifiques este código, ya que se genera automáticamente
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Interes Ganado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(interes_ganado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new interes_ganado().setVisible(true);
            }
        });
    }
